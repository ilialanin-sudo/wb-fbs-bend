...
ENV:
  WB_TOKEN_OOO, WB_TOKEN_IP     — персональные токены кабинетов (обязательно)
...
def load_cabinets():
    ...
    "cabinets": [{"key": "ooo", "title": "ООО", "env": "WB_TOKEN_OOO"}, ...]
...
def main():
    if not CABS:
        sys.exit("не задан ни один токен: нужны WB_TOKEN_OOO и/или WB_TOKEN_IP")
